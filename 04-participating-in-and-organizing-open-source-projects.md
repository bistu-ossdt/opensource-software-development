...
<div class="history-story">
  ...
  <p>如果今天的读者把开源协作想象成一条很自然的链：开一个仓库，建一个分支，发起 Pull Request，等别人 review，通过检查后再 merge，那么很容易忘记，这套流程并不是软件世界自古如此的常识。二十一世纪最初几年，Git 已经出现，但它更像一个强大而偏“工程师内行”的分布式版本控制工具；公开协作的很多痕迹仍然散落在邮件列表、仓库地址、提交历史和不同站点之间。Chris Wanstrath 正是在这样的背景下成为 GitHub 联合创始人之一的。对他和早期 GitHub 团队来说，真正的问题不是“怎样做一个更好看的代码托管网站”，而是“怎样把分支、补丁、讨论和合并组织成更多人都能进入的公共流程”。</p>
  <p>2008 年 GitHub 上线后，仓库、分支、提交、比较视图、Issue、Pull Request、公开讨论和后续集成，开始越来越多地被放到同一个地方。Chris Wanstrath 后来常被归入“把 Git 带给更多开发者的人”这一类叙述里，这种说法虽然简化了历史，却抓住了一个关键事实：现代开源开发流程之所以会以今天这种形态被大规模理解，很大程度上并不是因为每个人都先学会了 Git 的内部原理，而是因为平台把“修改必须先作为提案存在、必须先被 review、必须先形成公共记录，再进入主线”这条工程逻辑显性化了。也正因为如此，第 4 章真正要讲的并不是某个平台按钮，而是这套逻辑本身：工具界面可以变化，但变更控制、公开审查和主线保护之所以重要，不会跟着一起消失。</p>
</div>
