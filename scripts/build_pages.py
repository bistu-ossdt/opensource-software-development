...
MANUSCRIPT_PAGES = [
    ...
    ManuscriptPage(
        ...
        description="从仓库入口、治理信号与工程对象出发，建立面对陌生开源项目的整体阅读框架。当前为扩写稿。",
    ),
    ManuscriptPage(
        label="第 6 章 参与开源项目",
        source=ROOT / "06-participating-in-open-source-projects.md",
        output="chapter-06.html",
        description="从第一次贡献、贡献说明到 review 回复，建立参与真实项目的最小路径。当前为扩写稿。",
    ),
    ManuscriptPage(
    ...
    ManuscriptPage(
        ...
        description="从维护者视角组织公开仓库、版本发布、维护计划与最小安全基线。当前为初稿。",
    ),
    ManuscriptPage(
        label="附录 开源历史",
...
TEACHING_PAGES = [
    ...
    TeachingPage(
        ...
        description="帮助学生把第 5 章读成面对陌生仓库时的整体判断方法与行动选择。已与同章实验、附录和案例包同步，可直接配套使用。",
    ...
    TeachingPage(
        ...
        description="帮助教师组织第 5 章的项目阅读方法、案例对照与行动选择，并可配合评分尺与示例包组织完整教学。",
        chapter_output="chapter-05.html",
        chapter_label="第 5 章 阅读与理解开源项目",
        kind="教学指南",
    ),
    ...
    TeachingPage(
        ...
        description="帮助学生把第 8 章读成维护者视角下的项目公共界面、发布与维护基线。当前为初稿。",
    ...
    TeachingPage(
        ...
        description="帮助教师组织第 8 章的维护者视角、版本发布与最小安全基线。当前为初稿。",
        chapter_output="chapter-08.html",
        chapter_label="第 8 章 组织与发布你的开源项目",
        kind="教学指南",
    ),
...
LAB_PAGES = [
    ...
    TeachingPage(
        label="第 8 章 实验与项目材料",
        source=ROOT / "chapter-08-lab-project-materials.md",
        output="chapter-08-lab-project-materials.html",
        description="第 8 章的章节级实验 / 项目材料，围绕公开发布准备、版本承诺、维护计划与最小安全基线展开，并提供实验级评分尺。",
        chapter_output="chapter-08.html",
        chapter_label="第 8 章 组织与发布你的开源项目",
        kind="实验与项目材料",
    ),
...
APPENDIX_PAGES = [
    ...
    TeachingPage(
        label="第 8 章 附录支撑",
        source=ROOT / "chapter-08-appendix-support.md",
        output="chapter-08-appendix-support.html",
        description="第 8 章的附录支撑，提供发布前检查单、项目发布基线模板、维护计划、安全说明与最小示例包。",
        chapter_output="chapter-08.html",
        chapter_label="第 8 章 组织与发布你的开源项目",
        kind="附录支撑",
    ),
...
CASE_PACK_PAGES = [
    ...
    TeachingPage(
        label="第 6 章 案例教学包",
        source=ROOT / "chapter-06-case-teaching-pack.md",
        output="chapter-06-case-teaching-pack.html",
    ...
    TeachingPage(
        label="第 8 章 案例教学包",
        source=ROOT / "chapter-08-case-teaching-pack.md",
        output="chapter-08-case-teaching-pack.html",
        description="第 8 章的案例教学包，围绕 tldr-pages/tldr、Linux、CPython 与 OpenClaw 的公共界面、版本承诺与维护边界展开。",
        chapter_output="chapter-08.html",
        chapter_label="第 8 章 组织与发布你的开源项目",
        kind="案例教学包",
    ),
...
LAB_STAGES = [
    ...
    LabStage(
        ...
        href="chapter-08-lab-project-materials.html",
        chapters="第 8 章",
...
def build_home() -> None:
    ...
    <section class="status-note">
      <strong>当前状态：</strong>课程网站已具备全站导航、书稿阅读区、教学支持入口与实验/案例入口。当前上线内容包括第 1-8 章书稿、4 个附录、2 项书后工具材料（术语表与参考文献）、第 1-8 章教学支持、章节级实验材料、附录支撑与案例教学包；其中第 1-7 章与第 8 章正文已进入初稿或扩写稿阶段，第 1-5 章教学层已补齐基础支架，第 6 章已升级为成熟教学包，第 7 章已进入初稿，第 8 章教学支持已进入初稿。
    </section>
...
def build_course_page() -> None:
    ...
    <section>
      ...
      <ul class="feature-list">
        <li>书稿：第 1-7 章为扩写稿；第 8 章已进入初稿；已上线 4 个附录和 2 项书后工具材料。</li>
        <li>教学支持：第 1-8 章学习指南与教学指南已上线；其中第 1-5 章已补齐基础教学支架，第 6 章已升级为成熟教学包，第 7 章已进入初稿，第 8 章已进入初稿。</li>
        <li>章节级支撑材料：第 1-8 章均已接入实验与项目材料、附录支撑与案例教学包；其中第 1-5 章已完成一轮结构补齐，第 6 章已升级为成熟教学包，第 7-8 章处于初稿持续细化阶段。</li>
    ...
    <section>
      <h2 class="section-title">当前已上线的实验与项目材料（第 1-8 章）</h2>
      <div class="card-grid two">
    ...
    <section>
      <h2 class="section-title">当前已上线的附录支撑（第 1-8 章）</h2>
      <div class="card-grid two">
    ...
    <section>
      <h2 class="section-title">当前已上线的案例教学包（第 1-8 章）</h2>
      <div class="card-grid two">
...
def build_manuscript_index() -> None:
    ...
    <section class="status-note">
      当前在线书稿范围：第 1-8 章、4 个附录与 2 项书后工具材料；其中第 1-7 章为扩写稿，第 8 章已进入初稿。教学支持已接入第 1-8 章，其中第 5 章为初稿，第 6 章已升级为成熟教学包，第 7 章已进入初稿，第 8 章已进入初稿。
    </section>
    """
    sidebar = f"""
...
def build_teaching_index() -> None:
    ...
    <header class="page-header">
      <h1>教学支持目录</h1>
      <p>教学支持分区承接基于书稿的学习与教学支架。当前已上线第 1-8 章的学习指南与教学指南；其中第 1-5 章已补齐基础教学支架，第 6 章已升级为成熟教学包，第 7 章已进入初稿，第 8 章已进入初稿，可与对应书稿配套使用。</p>
    </header>
    ...
    <section class="status-note">
      当前在线教学支持范围：第 1-8 章；其中第 1-5 章已补齐基础教学支架，第 6 章已升级为成熟教学包，第 7 章已进入初稿，第 8 章已进入初稿，后续将继续做跨章统一精修。
    </section>
    """
    sidebar = f"""
    <div class="sidebar-block">
...
def build_labs_page() -> None:
    ...
    <section>
      ...
      <ul class="feature-list">
        ...
        <li>在后续阶段进入外部项目理解、第一次贡献与项目发布。</li>
      </ul>
    </section>
...
def build_cases_page() -> None:
    ...
    <section class="status-note">
      当前页已能承担课程级案例与参考入口功能：第 1-8 章案例教学包已上线，专题附录与书后工具材料已接入；后续会继续细化章节案例与跨章案例索引。
    </section>
    """
    write_page(
