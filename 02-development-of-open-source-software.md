...
把这个差异说得更具体一些，可以这样理解：自由软件更像是在回答“软件应当如何尊重使用者”，而开源软件更像是在回答“开放协作如何获得更广泛、可操作、可制度化的表达”。两者都在回应软件封闭化的问题，但前者以 freedom 为核心语言，后者以 licensing、redistribution 和 collaborative development 为更常见的工程语言。也正因为如此，现代开源项目里常见的很多实践，比如许可证选择、贡献规则、第三方复用、企业协作，并不意味着自由软件传统被遗忘了，而是说明这些问题已经被转写进更广泛的软件生产体系。
...
如果一定要进一步压缩成最小框架，可以这样记：宽松式传统优先解决“降低复用阻力”，Copyleft 传统优先解决“防止开放成果在传播中被重新封闭”，而 GPL、LGPL、AGPL、MPL 之间的区别，主要体现在这种开放义务到底覆盖多大范围、在哪些场景下生效。对绝大多数项目阅读和启动决策来说，这一层理解已经足够支撑第一轮判断。
