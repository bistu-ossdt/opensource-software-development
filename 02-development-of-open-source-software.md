...
<div class="history-story">
  ...
  <p>2007 年 9 月，美国纽约的法庭文件里第一次出现了一个对开源世界很重要的场景：被起诉的不是大型操作系统厂商，而是一家销售消费电子设备的公司；争议的中心，也不是一套庞大的软件系统，而是 BusyBox 这样一组常见得几乎不起眼的 Unix 工具。BusyBox 长期被嵌入路由器、机顶盒和各种固件之中，很多最终用户甚至不知道自己每天打开的设备里藏着它。也正因为如此，很多公司误以为：只要把二进制程序装进产品里，许可证问题就不会真正进入公众视野。</p>
  <p>事情恰恰相反。2007 年 9 月 20 日，Software Freedom Law Center 代表 BusyBox 开发者起诉 Monsoon Multimedia，理由很直接：对方在产品中分发了 GPLv2 许可下的 BusyBox，却没有按要求向接收者提供对应源代码。几周后的和解协议不只是要求补交源代码，还要求企业指定开源合规负责人并通知先前用户自己的权利。这件事之所以重要，不在于它制造了一场戏剧性的法律冲突，而在于它把一个常被低估的事实公开地摆在了工程世界面前：许可证不是仓库里的礼貌声明，而是会真实决定软件能否被合法分发、修改和继续协作的制度边界。</p>
</div>
...
- Software Freedom Law Center, “On Behalf of BusyBox Developers, SFLC Files First Ever U.S. GPL Violation Lawsuit”
- Software Freedom Law Center, “BusyBox Developers and Monsoon Multimedia Agree to Dismiss GPL Lawsuit”
