...
对前面几章一路推进下来的团队项目来说，发布前最后一次检查也不应只问“代码能否运行”，还应追问：外部人第一次进入时能否按 README 走通，能否从 `CHANGELOG` 判断这版交付了什么，能否知道发现问题后应去哪里报告，以及项目当前准备接住哪些请求、不接住哪些请求。只有这些问题都被回答，团队项目才真正完成了从课堂协作对象到公共项目的转换。
