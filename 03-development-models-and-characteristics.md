...
很多人第一次接触开源时，会把它想象成一种近乎自发的协作：代码公开了，感兴趣的人自然会加入，问题会被公开讨论，好的修改会被自动吸收，项目就会持续成长。只要真正观察几个经典项目，就会发现事情远没有这么简单。Linux 的补丁不会无序地直接流向主线，而是沿着维护者链条逐步流转；Apache 的项目也不是靠“谁都可以拍板”来运作，而是依赖具备提交权限的维护者（committers）、项目管理委员会（Project Management Committee, `PMC`）和长期形成的社区规范。开源之所以能够成为公共协作系统，不是因为它没有组织，而是因为它把组织方式尽量公开、可追溯、可继承地写了出来。
...
几乎所有成熟的开源项目都会逐渐形成角色梯度。最外层通常是使用者，他们下载、运行、反馈问题、判断项目是否值得继续关注。再往里是贡献者，他们提交文档、测试、缺陷修复或功能修改。再往里可能出现评审者、维护者、核心团队、项目管理委员会或指导委员会（`Steering Council`）等更稳定的角色。不同项目的名称不完全相同，但它们都在解决同一个问题：谁拥有什么权限，谁承担什么责任，谁可以对公共对象做出最终判断。
...
<div class="history-story">
  ...
  <p>这套结构在 Python 早期并不奇怪。语言设计需要连续性，社区也需要一个能做最终裁决的人。随着时间推移，围绕 Python 的不再只是 Guido 一个人的代码，而是越来越完整的公共协作体系：核心开发者群体、PEP 提案机制、版本发布节奏、Python 软件基金会（Python Software Foundation）以及更广泛的全球社区。也正因为如此，问题迟早会从“Guido 如何做判断”变成“如果没有 Guido，Python 还怎样继续判断”。2018 年 7 月 12 日，围绕 PEP 572 的激烈争论刚刚落下，Guido 向 <code>python-committers</code> 邮件列表发出那封标题为 “Transfer of power” 的邮件，宣布自己退出 BDFL 的最终决策角色，而且不会指定继任者。对外部旁观者来说，这像是一位长期核心人物的个人决定；但对 Python 社区来说，真正尖锐的问题立刻浮现出来：如果项目不能再依赖单一人物做最后裁决，那么 PEP 由谁拍板，核心开发者由谁接纳，权力又该如何被约束？</p>
  <p>接下来几个月里，Python 社区没有把这个问题重新交还给新的个人权威，而是把它转化成一轮公开的治理设计。不同治理方案被系统提出、讨论和投票，最终在 2018 年底选择了指导委员会（<code>Steering Council</code>）模型，并在后续形成正式的 <code>PEP 13</code>。从此，核心团队（<code>core team</code>）、指导委员会（<code>Steering Council</code>）、选举机制、任期、利益冲突限制和罢免条件，都被写进了项目的公共制度。这样回头看，Guido 在这段历史里的意义就不只是“写出了 Python”，而是他的退出迫使社区正面回答了一个所有成熟开源项目终将面对的问题：一个项目如果真的属于公共世界，就不能永远只靠某一个人的历史地位来维持秩序。它必须把个人权威尽量转化为可继承、可解释、可约束的治理结构。</p>
</div>
...
Apache 则展示了另一种经典路径。Apache 的许多项目围绕使用者（user）、开发者（developer）、具备提交权限的维护者（committer）、项目管理委员会成员（PMC member）这些角色组织起来。这里的关键词常被概括为“基于贡献积累信任”，但它更准确的含义并不是抽象的“精英主义”，而是持续贡献带来更高信任，更高信任意味着更高责任。committer 可以提交代码，PMC 则不仅关心代码本身，还要关心发布、项目方向、社区秩序和长期健康。与 Linux 的维护者链条相比，Apache 更强调社区化治理和项目层面的责任分担。两者不同，但共同点非常清楚：权限并不是天然平铺的，治理必须让“谁负责什么”逐步显性化。

Apache 这个案例尤其值得注意的地方，在于它把“社区重于代码”写成了一种运行原则，而不是口号。一个修改是否被接受，重要的不只是技术上能不能工作，还包括它是否符合项目当前方向、是否在合适的讨论中形成共识、是否由愿意长期承担责任的人来推进。很多 Apache 项目因此强调公开讨论、惰性共识（`lazy consensus`）、投票与 PMC 责任，这说明社区治理并不是技术判断之外的额外层，而是技术判断得以稳定落地的制度环境。
...
Python 提供了第三种值得补充的视角。它的正式治理结构由核心团队（`core team`）和指导委员会（`Steering Council`）组成，指导委员会由核心团队选举产生。这个案例之所以重要，不只是因为它展示了“选举”这种形式，而是因为它把治理的另一层问题公开化了：成熟项目不仅要决定技术方向，还要维护语言与实现的质量和稳定性，保持社区健康，并处理潜在的权力失衡。例如，Python 的正式治理文本明确限制同一雇主在指导委员会中的人数上限，这说明治理不仅处理技术争议，也处理利益边界。
...
如果再把这种差异压缩成最小框架，可以得到一个更容易迁移的判断：Linux 这一类项目首先要解决“复杂代码与维护责任如何分层收束”，Apache 这一类项目首先要解决“社区共识如何持续组织成项目责任”，Python 这一类项目则更集中地回答“个人权威退场后，正式制度如何接手最终裁决”。模型不同，但三者都在处理同一件事：怎样把公共控制权从模糊信任转成可解释结构。
...
对外部人来说，这条进入路径通常并不神秘。很多人最早只是使用者，随后通过问题报告、文档修订、测试反馈或小型缺陷修复逐步建立可信记录；再往后，才可能承担更稳定的评审、分诊、维护或发布责任。真正成熟的治理结构，通常不会让“进入核心”变成私人邀请制的黑箱，而会通过公开讨论、可见责任和持续贡献，让后来者看见自己如何从外围一步步接近项目责任中心。
...
如果把现代仓库里更细的治理对象也算进来，这个结构会更完整。Issue 模板与表单会预先规定“什么样的问题才算进入公共讨论”“哪些信息必须先提供”；Pull Request 模板则把“为什么改、怎么测、关联什么上下文”变成默认要求。`CODEOWNERS` 把某些路径的评审责任直接写成仓库对象，分支保护与规则集（`rulesets`）则进一步把评审、状态检查和合并门禁固定下来。它们看起来像平台功能，但治理意义非常明确：项目不再只靠维护者临场解释规则，而是把部分责任分工和进入门槛提前写进公共结构。

以 GitHub 的社区概况（community profile）为例，它把 README、许可证、贡献说明、行为准则、安全策略以及模板这类对象汇成一组可检查的“社区标准”入口，等于在提醒维护者和贡献者：一个项目是否具备公共协作的最低表面，并不只体现在代码是否公开，也体现在治理入口是否齐备。对外部人来说，这些对象同样构成了判断依据，因为它们直接说明项目有没有为陌生协作者准备进入路径。
...
因此，社区健康首先是一个治理问题。更值得关注的往往是这些信号：Issue 和变更请求的响应速度如何，贡献者是否能够留下来，维护责任是否被合理分散，是否存在明显的单点维护者风险，项目是否给后来者提供了逐步进入的路径。今天围绕开源社区健康已经形成了专门的指标框架，例如 CHAOSS 社区健康指标框架就提供了一整套观察社区活跃、响应和可持续性的思路。对一般读者而言，不需要背诵指标名称，但至少应建立一个稳定判断：受关注不等于健康，热闹不等于可持续。
...
反过来看，一个看起来“很热闹”的项目也可能已经处在不健康状态：Issue 不断堆积，却很少有人得到第一次回应；Pull Request 平均等待数月，关键目录长期只有一个人能合并；贡献指南、版本说明和治理文件还停留在旧状态，却没有人持续维护。这样的项目未必缺少关注度，但它已经在用表面活跃掩盖治理债务。对外部贡献者而言，真正的困难也往往不是“这个项目太难”，而是“没有人能把项目继续往前推动”。
...
换句话说，第 3 章回答的是“谁在判断、怎样沟通、责任如何被解释和继承”；下一章要讨论的，则是这些判断如何通过版本控制、变更评审、测试与自动化机制真正进入主线。治理解决公共协作的组织前提，工程流程解决公共协作的日常落地。两者不能互相替代，但也不能分开理解。
